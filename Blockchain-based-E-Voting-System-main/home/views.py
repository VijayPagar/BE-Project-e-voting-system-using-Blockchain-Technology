    ...
    if to_do['createPoliticianParties']:
        ...
        parties = {
            'bjp': {
                ...
                'party_logo': 'https://en.wikipedia.org/wiki/Bharatiya_Janata_Party#/media/File:Bharatiya_Janata_Party_logo.svg',
                'candidate_name': '',
            ...
            'congress': {
                ...
                'party_logo': 'https://en.wikipedia.org/wiki/Indian_National_Congress#/media/File:Indian_National_Congress_logo.svg',
                'candidate_name': '',
                'candidate_profile_pic': ''
                },
            'bsp': {
